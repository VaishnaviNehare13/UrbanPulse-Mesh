...
export default function IncidentPanel({ 
  ...
  return (
    <div className="space-y-3.5 text-xs text-slate-800 select-none font-sans">
      ...
      {/* 14. DECISION SUPPORT (STATE 2 vs STATE 3) */}
      {!isResolved ? (
        <div className="border border-slate-300 bg-white rounded-xs p-3 space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-2 text-[11px]">
            <div className="bg-slate-50 border border-slate-200 p-2 rounded-xs">
              <span className="text-[9px] text-slate-500 block font-medium uppercase">Without Intervention</span>
            ...
            <div className="bg-emerald-50/50 border border-emerald-200 p-2 rounded-xs">
              <span className="text-[9px] text-emerald-800 block font-medium uppercase">With Coordinated Diversion</span>
          ...
          {showConfirmModal ? (
            <div className="p-2.5 bg-slate-50 border border-blue-300 rounded-xs space-y-2 mt-2">
              <div className="flex items-start gap-1.5">
                ...
                <div>
                  <div className="font-bold text-xs text-slate-900">Apply coordinated diversion?</div>
                  <div className="text-[11px] text-slate-600 mt-0.5">
                    Expected traffic delay: <strong className="text-slate-800">18 min → 9 min</strong>
                  </div>
                </div>
              </div>
        ...
        <div className="border border-emerald-300 bg-emerald-50/40 rounded-xs p-3 space-y-3">
          ...
          <div className="p-2 bg-white/80 border border-emerald-200 rounded-xs text-[11px] flex items-center justify-between">
            <div>
              <span className="text-[9px] uppercase font-bold text-slate-400 block">ACTION RECORDED</span>
              <span className="font-semibold text-slate-800">City Administrator</span>
            </div>
